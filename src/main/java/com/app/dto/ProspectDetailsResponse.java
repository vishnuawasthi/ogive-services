...
public class ProspectDetailsResponse {
	...
	public String toString() {
		return "ProspectDetailsResponse [id=" + id + ", salutation=" + salutation + ", firstName=" + firstName
				+ ", lastName=" + lastName + ", familyName=" + familyName + ", idNumber=" + idNumber + ", address="
				+ address + ", email=" + email + ", mobileNumber=" + mobileNumber + ", advisorCode=" + advisorCode
